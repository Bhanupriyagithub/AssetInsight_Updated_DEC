...
public class RetentionStepDef16 extends PageInstances {
    ...
    public boolean validateEachItemOfPresentInDetailPage(List<String> itemList) throws Throwable {
        boolean flag = false;

        flag = datGovernancePage.verifyPRDInDetail(itemList);
    ...
    public void iVerifyThatIfTheLimitExceedsValidationMessageShouldGetDisplayedForProduct(List<String> textList) throws Throwable {
        for (String text : textList) {
            Assert.assertTrue(datGovernancePage.verifyIfTheLimitExceedsPRDNameValidationMessageShouldGetDisplayed(text));
        }
    }
}

...
*/
  /*  @Then("^I verify that excel document \"([^\"]*)\" with sheet name \"([^\"]*)\" , row number \"([^\"]*)\" and cell number \"([^\"]*)\" in report page and downloaded excel report are matching$")
    ...
    @And("^I click on \"([^\"]*)\" in detail page$")
    public void iClickOnInDetailPage(String arg0) throws Throwable {
        Assert.assertTrue(technologyPage.clickOnDataGoveranacedetail());
    }

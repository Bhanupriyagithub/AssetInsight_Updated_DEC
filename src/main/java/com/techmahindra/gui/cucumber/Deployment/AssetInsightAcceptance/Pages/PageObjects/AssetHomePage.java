...
public class AssetHomePage extends BasePage {
    ...
    public boolean clickOnHeaderOptions(String option,String Menu) {
         switch (Menu.toLowerCase()) {
                case "header":
                    try {
                        //HighlightAnElement.highlightElement(driver,driver.findElement(By.xpath(String.format(XPATH_HEADER_MENU_OPTIONS, option))));
        ...
        switch (Menu.toLowerCase()) {
            case "header":
                switch (option.toLowerCase()){
                    ...
                    HighlightAnElement.highlightElement(driver,assetIncitesHomePage);

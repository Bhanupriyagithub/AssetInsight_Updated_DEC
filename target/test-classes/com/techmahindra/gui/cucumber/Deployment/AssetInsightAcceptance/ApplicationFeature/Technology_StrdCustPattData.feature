@Feature_TechnologyPage_StndrCustPattData
Feature: I verify Sensitive TR data for Technology


  Background:  Given Asset Insight Home page should be displayed

  @AC_HomePage_StndrCustPattData_01
  ...
  @AC_TechnologyPage_StndrCustPattData_02
  ...
  @AC_TechnologyPage_StndrCustPattData_03
  Scenario Outline: I Verify the Existing Application
    ...
    Then I verify "<NewfieldName>" is displayed in DataGovernance for applicatiin
    Then I verify "<NewfieldName>" is displayed in DataGovernance is mandatory for applic
    Then I verify type of "<NewfieldName>" for applictn
    Then I click on NO radio button of "<NewfieldName>" for applictn
    Then I click on YES radio button of "<NewfieldName>" for applictn
    Then I click on "Save/Validate" button
